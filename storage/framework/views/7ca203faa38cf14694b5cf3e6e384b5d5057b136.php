...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title'); ?> 
        <?php echo e(__('Sesiones actuales')); ?>

     <?php $__env->endSlot(); ?>

     <?php $__env->slot('description'); ?> 
        <?php echo e(__('Administra y cierra sesión de tus sesiones activas en otros navegadores o dispositvos.')); ?>
...
<?php $component->withAttributes(['wire:click' => 'confirmLogout','wire:loading.attr' => 'disabled']); ?>
                <?php echo e(__('Cerrar sesión en otros navegadores o dispositivos')); ?>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\pfj\resources\views/profile/logout-other-browser-sessions-form.blade.php ENDPATH**/ ?>