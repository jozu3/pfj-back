...
<button id="guardar" class="btn btn-success btn-sm">Guardar cambios</button>
    <h2 class="txt-yellow-pfj font-weight-bold"><?php echo e($programa->nombre); ?></h2>
...
<?php $__env->startSection('content'); ?>
    ...
    <section class="content pb-3">
        <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('admin.asignar-personal', ['programa' => $programa])->html();
} elseif ($_instance->childHasBeenRendered($programa->id)) {
    $componentId = $_instance->getRenderedChildComponentId($programa->id);
    $componentTag = $_instance->getRenderedChildComponentTagName($programa->id);
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild($programa->id);
} else {
    $response = \Livewire\Livewire::mount('admin.asignar-personal', ['programa' => $programa]);
    $html = $response->html();
    $_instance->logRenderedChild($programa->id, $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </section>
                ...
                if (k.includes('grupo-') && value != '') {
                   ...
                   // console.log('grupo' + k.split('grupo-')[1])
                    ...
                    for (let j = 0; j < arr.length; j++) {
                        ...
                        $.ajax({
                            type: "POST",
                            url: `<?php echo e(route('admin.companerismos.index')); ?>/`+ comp,
                            data: {
                                _method: 'PUT',
                                _token: "<?php echo e(csrf_token()); ?>",
                                grupo_id: grupo,
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pfj\resources\views/admin/programas/asignar.blade.php ENDPATH**/ ?>