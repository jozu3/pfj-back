                    ...
                    <?php $__currentLoopData = $inscripciones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inscripcione): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <div class="flex items-center">
                              <div class="ml-4">
                                ...
                                <div class="text-sm text-gray-500">
                                  <?php echo e(date('d/m/Y', strtotime($inscripcione->programa->fecha_inicio))); ?>                                
                                </div>
                              </div>
                            </div>
                          </td>
                          ...
                          <td width=" 10px" class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <a href="<?php echo e(route('st.programas.show', $inscripcione->programa)); ?>" class="text-indigo-600 text-3xl hover:text-indigo-900"><i class="fas fa-chevron-circle-right"></i></a>
                          </td>
...
<?php /**PATH C:\xampp\htdocs\pfj\resources\views/vendor/jetstream/components/welcome.blade.php ENDPATH**/ ?>