            ...
            function OverlayScrollbarsInstance(pluginTargetElement, options, extensions, globals, autoUpdateLoop) {
                ...
                *  }
                ...
                function getTextareaInfo() {
                    //read needed values
                    var textareaPfjrPosition = _targetElementNative.selectionStart;
                    if (textareaPfjrPosition === undefined)
                        return;
                    ...
                    var textareaCurrentPfjrRowSplit = textareaValue.substr(0, textareaPfjrPosition).split('\n');
                    var widestRow = 0;
                    var textareaLastCol = 0;
                    var cursorRow = textareaCurrentPfjrRowSplit[LEXICON.l];
                    var cursorCol = textareaCurrentPfjrRowSplit[textareaCurrentPfjrRowSplit[LEXICON.l] - 1][LEXICON.l];
                    var rowCols;
                    var i;
                    ...
                    return {
                        ...
                        _cursorPosition: textareaPfjrPosition, //pos
